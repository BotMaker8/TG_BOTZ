...
SHORTLINK_API = environ.get('SHORTLINK_API', 'd49b12e8ec6405d20a8c7997fc81378bcc18b669')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ROYALMOVIESKING1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtoopenlinkssri/20')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Maintained By Manjunatha')
...
URL = "https://advancemoviefilterbot-62322f1440d0.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://advancemoviefilterbot-62322f1440d0.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://advancemoviefilterbot-62322f1440d0.herokuapp.com/".format(FQDN)
else:
    URL = "https://advancemoviefilterbot-62322f1440d0.herokuapp.com/".format(FQDN)
