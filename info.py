...
URL = "https://advancehitmoviessearchbot.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://advancehitmoviessearchbot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://advancehitmoviessearchbot.onrender.com/".format(FQDN)
else:
    URL = "https://advancehitmoviessearchbot.onrender.com/".format(FQDN)
